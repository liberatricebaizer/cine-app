      ...
      <div className="mt-10 xl:grid flex-colo grid-cols-5 gap-12 bg-dry xs:p-10 py-10 px-2 sm:p-20 rounded">
        <div className="xl:col-span-2 w-full flex flex-col gap-8">
          ...
          <p className="text-sm leading-7 font-medium text-border">
            Write your review of this this movie. It will be posted here. fell
        ...
        <div className="col-span-3 flex flex-col gap-6">
          <h3 className="text-xl text-white font-semibold flex gap-3 items-center ">
            <FaStar className="text-groon" /> Movie Reviews(45)
          </h3>
          <div className="w-full flex flex-col bg-main gap-6 rounded-lg md:p-12 p-6 h-header overflow-y-scroll ">
            {UsersData.map((user, i) => (
              <div className="md:grid flex flex-col w-full grid-cols-12 gap-6 bg-dry border border-gray-800 rounded-lg ">
